...
import { StoreTransferLine } from './items/store-transfer-line';
import { StoreTransfer } from './items/store-transfer';
...
meta.set(PaymentSystem, {
  ...
  fields: {
    is_default: { type: 'boolean', isEntity: false, isCollection: false, isEmbedded: false, },
    name: { type: 'string', isEntity: false, isCollection: false, isEmbedded: false, },
    paymentCollection: { type: Payment, isEntity: false, isCollection: true, isEmbedded: false, },
  }
});
...
meta.set(File, {
  ...
  fields: {
    ...
    stockCountCollection: { type: StockCount, isEntity: false, isCollection: true, isEmbedded: false, },
    ticketCollection: { type: Ticket, isEntity: false, isCollection: true, isEmbedded: false, },
...
meta.set(Invoice, {
  ...
  fields: {
    ...
    fileCollection: { type: File, isEntity: false, isCollection: true, isEmbedded: false, },
    paymentCollection: { type: Payment, isEntity: false, isCollection: true, isEmbedded: false, },
    total_payment: { type: 'string', isEntity: false, isCollection: false, isEmbedded: false, },
  }
});
...
meta.set(StockLine, {
  ...
  fields: {
    ...
    stockLogCollection: { type: StockLog, isEntity: false, isCollection: true, isEmbedded: false, },
...
meta.set(Item, {
  ...
  fields: {
    ...
    stockLineCollection: { type: StockLine, isEntity: false, isCollection: true, isEmbedded: false, },
    stockLogCollection: { type: StockLog, isEntity: false, isCollection: true, isEmbedded: false, },
    storeTransferLineCollection: { type: StoreTransferLine, isEntity: false, isCollection: true, isEmbedded: false, },
  }
});
...
meta.set(StockCount, {
  tableName: 'items.stock_count',
  fields: {
    date: { type: 'date', isEntity: false, isCollection: false, isEmbedded: false, transform: (v: any) => v ? new Date(v) : v, },
    file: { type: File, isEntity: true, isCollection: false, isEmbedded: false, },
    stockLogCollection: { type: StockLog, isEntity: false, isCollection: true, isEmbedded: false, },
  }
});

meta.set(StockLog, {
  tableName: 'items.stock_log',
  fields: {
    ...
    item: { type: Item, isEntity: true, isCollection: false, isEmbedded: false, },
    stockCount: { type: StockCount, isEntity: true, isCollection: false, isEmbedded: false, },
    stockLine: { type: StockLine, isEntity: true, isCollection: false, isEmbedded: false, },
    store: { type: Store, isEntity: true, isCollection: false, isEmbedded: false, },
    storeTransferLine: { type: StoreTransferLine, isEntity: true, isCollection: false, isEmbedded: false, },
  }
});
...
meta.set(Store, {
  ...
  fields: {
    ...
    stockLineCollection: { type: StockLine, isEntity: false, isCollection: true, isEmbedded: false, },
    stockLogCollection: { type: StockLog, isEntity: false, isCollection: true, isEmbedded: false, },
    stockLogStoreAuxCollection: { type: StockLog, isEntity: false, isCollection: true, isEmbedded: false, },
    storeTransferStoreSourceCollection: { type: StoreTransfer, isEntity: false, isCollection: true, isEmbedded: false, },
    storeTransferStoreTargetCollection: { type: StoreTransfer, isEntity: false, isCollection: true, isEmbedded: false, },
  }
});

meta.set(StoreTransfer, {
  tableName: 'items.store_transfer',
  fields: {
    date: { type: 'date', isEntity: false, isCollection: false, isEmbedded: false, transform: (v: any) => v ? new Date(v) : v, },
    sourceStore: { type: Store, isEntity: true, isCollection: false, isEmbedded: false, },
    targetStore: { type: Store, isEntity: true, isCollection: false, isEmbedded: false, },
    storeTransferLineCollection: { type: StoreTransferLine, isEntity: false, isCollection: true, isEmbedded: false, },
  }
});

meta.set(StoreTransferLine, {
  tableName: 'items.store_transfer_line',
  fields: {
    quantity: { type: 'big', isEntity: false, isCollection: false, isEmbedded: false, },
    item: { type: Item, isEntity: true, isCollection: false, isEmbedded: false, },
    storeTransfer: { type: StoreTransfer, isEntity: true, isCollection: false, isEmbedded: false, },
    stockLogCollection: { type: StockLog, isEntity: false, isCollection: true, isEmbedded: false, },
  }
});
...
meta.set(Payment, {
  tableName: 'accounting.payment',
  fields: {
    date: { type: 'date', isEntity: false, isCollection: false, isEmbedded: false, transform: (v: any) => v ? new Date(v) : v, },
    quantity: { type: 'big', isEntity: false, isCollection: false, isEmbedded: false, },
    paymentSystem: { type: PaymentSystem, isEntity: true, isCollection: false, isEmbedded: false, },
    invoiceCollection: { type: Invoice, isEntity: false, isCollection: true, isEmbedded: false, },
    ticketCollection: { type: Ticket, isEntity: false, isCollection: true, isEmbedded: false, },
  }
});
