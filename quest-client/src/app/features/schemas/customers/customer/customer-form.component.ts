...
import { ContactGridFieldComponent } from '../../contacts/contact/contact-grid-field.component';
...
export default class CustomerFormComponent implements OnInit, AocUiWindowDynConfigurable {
