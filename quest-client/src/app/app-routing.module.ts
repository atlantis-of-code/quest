...
const routes: Routes = [
  ...
  //TODO: Path of First time company configuration, if still no company, wizard
  {
    ...
    children: [
      ...
      {
        path: 'common',
        loadChildren: () => import('./features/schemas/common/common.module')
      },
      {
        path: 'customers',
      ...
      {
        path: 'items',
        loadChildren: () => import('./features/schemas/items/items.module')
      },
      {
        path: 'invoicing',
        loadChildren: () => import('./features/schemas/invoicing/invoicing.module')
      },
      {
