...
export class Ticket extends QuestEntity {
  ...
  @ManyToOne({ entity: () => 'Customer', fieldName: 'customer_id', nullable: true })
  customer?: Customer;
  ...
  @ManyToMany({ entity: () => 'Payment', pivotTable: 'accounting.ticket_payment', joinColumn: 'ticket_id', inverseJoinColumn: 'payment_id', cascade: [Cascade.REMOVE] })
